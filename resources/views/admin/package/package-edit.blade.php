                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="max_days" name="max_days" placeholder="30"
                            value="{{$package->max_days}}">
                    </div>

                    <div class="form-group">
                        <label for="max_users">max_users</label>
                        <input type="number" class="form-control" id="max_users" name="max_users" placeholder="30"
                            value="{{$package->max_users}}">
                    </div>

                    <div class="form-group">
                        <label>downloaded</label>
                        <select class="custom-select" name="is_downloaded" value="{{$package->is_downloaded}}">
                            <option value="0" {{ $package->is_downloaded === 0 ? "selected" : "" }}>No</option>
                            <option value="1" {{ $package->is_downloaded === 1 ? "selected" : "" }}>Yes</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label>4k</label>
                        <select class="custom-select" name="is_4k" value="{{$package->is_4k}}">
                    ...
                    <div class="form-group">
                        <label>active</label>
                        <select class="custom-select" name="is_active" value="{{$package->is_active}}">
                            <option value="0" {{ $package->is_active === 0 ? "selected" : "" }}>No</option>
                            <option value="1" {{ $package->is_active === 1 ? "selected" : "" }}>Yes</option>
                        </select>
                    </div>
                </div>
                <!-- /.card-body -->
