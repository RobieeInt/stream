      ...
      <form enctype="multipart/form-data" method="POST" action="{{route('admin.movie.update', $movie->id)}}">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="number" min="1" max="10" class="form-control" id="rating" name="rating" placeholder="Rating" value="{{$movie->rating}}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="small-thumbnail" name="small_thumbnail">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="large-thumbnail" name="large_thumbnail">
                <label class="custom-file-label" for="large-thumbnail">Change Large Thumbnail</label>
              </div>
            {{-- <input type="file" class="form-control" name="large_thumbnail" > --}}
          </div>
          <div class="form-group">
            <label for="description">Short About</label>
            <input type="text" class="form-control" id="description" name="description" placeholder="Awesome Movie" value="{{$movie->description}}">
          </div>
          <div class="form-group">
            <label for="long_description">About</label>
            <input type="text" class="form-control" id="long_description" name="long_description" placeholder="Awesome Movie" value="{{$movie->long_description}}">
          </div>
          <div class="form-group">
