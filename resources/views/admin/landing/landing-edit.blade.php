...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form enctype="multipart/form-data" method="POST" action="{{route('admin.landing.update', $landing->id)}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hero_title" name="hero_title"
                            placeholder="e.g Pengacara & Konsultan Hukum" value="{{$landing->hero_title}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="hero_description" id="hero_description" cols="30"
                            rows="10">{{ $landing->hero_description }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hero_video_link" name="hero_video_link" placeholder="Video url"
                            value="{{$landing->hero_video_link}}">
                    </div>
                    <div class="form-group">
                        <label for="footer_description">Footer Description</label>
                        <textarea name="footer_description" id="footer_description" cols="30"
                            rows="10">{{ $landing->footer_description }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="address">address</label>
                        <textarea name="address" id="address" cols="30"
                            rows="10">{{$landing->address }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="phone">phone</label>
                        <input type="text" class="form-control" id="phone" name="phone"
                            placeholder="e.g Pengacara & Konsultan Hukum" value="{{$landing->phone}}">
                    </div>

                    <div class="form-group">
                        <label for="email">email</label>
                        <input type="text" class="form-control" id="email" name="email"
                            placeholder="e.g Pengacara & Konsultan Hukum" value="{{$landing->email}}">
                    </div>
